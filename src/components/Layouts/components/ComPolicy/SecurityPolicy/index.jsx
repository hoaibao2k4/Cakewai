    ...
    return(
        <div className="mx-28 my-28 items-center text-primary text-black">
            ...
            <ol className="text-lg list-decimal pl-10 text-left text-black ">
                <li className="font-bold italic my-4">Mục đích và phạm vi thu thập thông tin:</li>
                ...
                <li className="font-bold italic my-4">Phạm vi sử dụng thông tin </li>
                ...
                Thông tin về khách hàng là vấn đề mang tính cá nhân, sự tôn trọng khách hàng vì vậy trong mọi trường hợp chúng tôi cam kết: <br />
                ...
                - Để bảo vệ Anh Hòa Bakery trong trường hợp có tranh chấp phát sinh cần giải quyết <br />
                ...
                <li className="font-bold italic my-4">Thời gian lưu trữ thông tin</li>
                ...
                <li className="font-bold italic my-4"> Phương tiện và công cụ để người dùng tiếp cận và chỉnh sửa dữ liệu cá nhân của mình</li>
                ...
                <li className="font-bold italic my-4">Cam kết bảo mật thông tin cá nhân khách hàng</li>
                - Chúng tôi bảo mật tuyệt đối các thông tin tài khoản của Quý khách hàng. <br />

                - Quý khách hàng phải có trách nhiệm bảo vệ mật khẩu của mình tránh để bên thứ ba nắm được thông tin tài khoản, mật khẩu của Quý khách. <br />

                - Trường hợp có thắc mắc và cần giải đáp về thông tin cá nhân Quý khách hàng vui lòng liên hệ với chúng tôi quá số điện thoại hotline hoặc email để được giải đáp. <br />
            </ol>
        </div>
    );
}

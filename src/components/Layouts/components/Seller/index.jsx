  ...
  return (
    <div className="best-seller">
      ...
      <div className="Our-product relative flex w-full justify-evenly">
        <div className="my-10 w-[300px] img-scale">
          <a href="#">
            <img src={tessaCake} alt="" width="300px" />
          </a>
          <div className="bg-secondary rounded-b-xl pb-10">
            <div className="mx-4 flex justify-between py-6">
              <h3 className="text-2xl">Bakery</h3>
              <a
                href="#"
                className="rounded-full bg-primary px-4 py-0.5 text-slate-100"
              >
                Buy Now
              </a>
            </div>

...
function AboutUs() {
  return (
    <div className="mx-full font-inter mt-28 w-full items-center overflow-hidden text-black text-primary">
      ...
      <div
        className="img-scale mt-5 h-[300px] w-full overflow-hidden bg-cover bg-center"
      ...
      >
        ...
        >
          <div className="ml-20 max-w-lg text-left">
            <Link to="/about?mode=info1" className="text-5xl font-bold text-white hover:text-yellow-500">
              Câu chuyện
            </Link>
      ...
      <div
        className="img-scale h-[300px] w-full overflow-hidden bg-cover bg-center"
